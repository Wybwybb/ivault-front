        ...
        <div class="max-w-md mx-auto text-center bg-gray-800 :border-gray-700 px-4 sm:px-8 py-10 rounded-xl shadow">
            ...
            <form id="otp-form" @submit.prevent="verifyAccount">
                <div class="flex items-center justify-center gap-3">
                    <input
                        type="text"
                        class="w-14 h-14 text-center text-2xl font-extrabold text-slate-600 bg-slate-100 border border-transparent hover:border-slate-200 appearance-none rounded p-4 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
