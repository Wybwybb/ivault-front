          ...
          <div class="space-y-4 md:space-y-6" action="#">
            ...
            <div>
              ...
              v-model="password"
                ...
                id="password"
                placeholder="•••••••••••••"
                class=" text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required=""
              />
            </div>
